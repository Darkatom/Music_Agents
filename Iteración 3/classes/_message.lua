...
function Message:Update( dt )
         if (self.x + _messages_diam/2 < self.dest_x + _agents_width/2)
         or (self.x + _messages_diam/2 > self.dest_x + _agents_width/2) then
            self.x = self.x + dt*self.vel_x
         end

         if (self.y + _messages_diam/2 < self.dest_y + _agents_height/2 )
         or (self.y + _messages_diam/2 > self.dest_y + _agents_height/2 ) then
